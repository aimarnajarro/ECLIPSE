...
bool	CCExplorerManager::EDROOM_CTX_Top_0::GFwdToGuidance_TC()

{

return VCurrentTC.IsGuidance_TC;
	...
	do
	{
		...
		switch(edroomCurrentTrans.localId)
		{
			...
			case (HandleTC):
				...
				//Evaluate Branch FwdToGuidance
				else if( GFwdToGuidance_TC() )
				{
					//Send Asynchronous Message 
					FFwdGuidanceTC();

					//Branch taken is HandleTC_FwdToGuidance
					edroomCurrentTrans.localId =
						HandleTC_FwdToGuidance;
